...
public class VideoHelper implements IVLCVout.OnNewVideoLayoutListener {
    ...
    public VideoHelper(Activity activity, LibVLC mLibVLC, MediaPlayer mMediaPlayer, int video_surface_frame, int surface_stub, int subtitles_surface_stub, int texture_stub) {
        this.mActivity = activity;
        this.mLibVLC = mLibVLC;
        this.mMediaPlayer = mMediaPlayer;

        mVideoSurfaceFrame = (FrameLayout) mActivity.findViewById(video_surface_frame);
        if (USE_SURFACE_VIEW) {
            ViewStub stub = (ViewStub) mActivity.findViewById(surface_stub);
            mVideoSurface = (SurfaceView) stub.inflate();

            if (ENABLE_SUBTITLES) {
                stub = (ViewStub) mActivity.findViewById(subtitles_surface_stub);
            ...
            ViewStub stub = (ViewStub) mActivity.findViewById(texture_stub);
    ...
    private void updateVideoSurfaces() {
        ...
        double dw = sw, dh = sh;
        final boolean isPortrait = mActivity.getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT;
